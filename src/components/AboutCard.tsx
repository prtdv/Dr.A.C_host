        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              With over a decade of experience in orthopedic care, Dr. Abhishek Chachan is dedicated to providing 
              precise, patient-first treatment for bone and joint conditions. His expertise spans joint replacement, 
              spine surgery, and trauma management, helping thousands of patients return to active, pain-free lives.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-semibold text-foreground">MBBS, MS (Orthopedics)</div>
                  <div className="text-xs text-muted-foreground">Qualified Orthopedic Surgeon</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-medical-blue-light flex items-center justify-center shrink-0">
                ...
                <div>
                  <div className="text-sm font-semibold text-foreground">Monilek Hospital, Jaipur</div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-semibold text-foreground">Shyam Poly Clinic, Jagatpura</div>
                  <div className="text-xs text-muted-foreground">Lead Practitioner</div>
                </div>
              </div>
            </div>
